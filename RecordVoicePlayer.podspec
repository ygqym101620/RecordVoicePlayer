...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://yangguoqiang@bitbucket.org/yangguoqiang/recordvoiceplayer.git'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ygqym101620' => 'yanggq101620@163.com' }
  s.source           = { :git => 'https://yangguoqiang@bitbucket.org/yangguoqiang/recordvoiceplayer.git', :tag => s.version.to_s }
